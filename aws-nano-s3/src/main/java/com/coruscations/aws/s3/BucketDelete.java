...
class BucketDelete extends BucketRestCommand<EmptyRestCommandResponse> {

  private static final Logger LOG = Logger.getLogger(BucketDelete.class.getName());

  public BucketDelete(String bucketName) {
    super(bucketName);
  }
