...
class BucketDeleteCors extends BucketRestCommand<EmptyRestCommandResponse> {

  private static final Logger LOG = Logger.getLogger(BucketDeleteCors.class.getName());

  protected BucketDeleteCors(String bucketName) {
    super(bucketName);
  }
